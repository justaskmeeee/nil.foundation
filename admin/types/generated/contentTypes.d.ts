...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    recommendedBlogs: Attribute.Relation<
      'api::blog.blog',
      'oneToMany',
      'api::blog.blog'
    >;
...
export interface ApiConfigConfig extends Schema.SingleType {
  ...
  attributes: {
    isGlossaryOn: Attribute.Boolean & Attribute.DefaultTo<false>;
    isResearchTagsOn: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiGlossaryGlossary extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paragraphs: Attribute.Component<'word.paragraphs', true>;
...
export interface ApiResearchesResearches extends Schema.CollectionType {
  collectionName: 'research';
  info: {
    singularName: 'researches';
    pluralName: 'research';
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::researches.researches': ApiResearchesResearches;
